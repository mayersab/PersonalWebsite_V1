...
export const blogSite = {
    title: 'BlogSite',
    description: 'My goal with this project was to really demonstrate the skills that I gained and improved upon during my time as CL intern. This blog uses JWT for user authentication and a backend built with node.JS/Express to communicate with a mongoDB database.',
...
export const cvApp = {
    title: 'CV-Applicaton',
    description: 'For my first React project, I built and designed a simple CV app. This app focuses heavily on core React concepts like state management, props, and class based components. Through building this project, my thought process in how to think of developing react based applications was strengthened. In the future I’d like to improve this project by utilizing functional components and hooks as well as implementing form validation.',
